...
export default function NeoBDMSummaryPage() {
    ...
    return (
        <div className="flex flex-col gap-0 p-0 min-h-screen bg-[#0f1115] text-zinc-100 font-mono">
            {/* Header / Config Bar */}
            <div className="flex flex-wrap items-center justify-between gap-2 bg-[#181a1f] p-2 lg:p-1 border-b border-zinc-800/60 sticky top-0 z-30 lg:z-40 backdrop-blur-md bg-opacity-90">
            ...
            {/* Footer */}
            <div className="bg-[#181a1f] border-t border-zinc-800 px-2 py-1.5 lg:py-0.5 text-[9px] text-zinc-500 flex flex-wrap justify-between items-center select-none gap-2">
                <div className="flex gap-2 lg:gap-4 items-center order-2 lg:order-1">
                    <span className="hidden sm:inline">Showing {paginatedData.length} of {processedData.length} rows</span>
                ...
                <div className="hidden sm:flex gap-4 opacity-50 hover:opacity-100 transition-opacity cursor-pointer text-[8px] order-3">
