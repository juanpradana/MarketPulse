...
export default function NeoBDMTrackerPage() {
    ...
    return (
        <div className="flex flex-col gap-0 min-h-screen bg-[#0f1115] text-zinc-100 font-mono">
            {/* Top Navigation Bar */}
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between bg-[#181a1f] p-2 border-b border-zinc-800/60 sticky top-0 z-40 backdrop-blur-md bg-opacity-90 gap-2">
